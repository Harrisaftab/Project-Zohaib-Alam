                                                                ...
                                                                <div class="mobile_navbar">
                                                                    <ul class="mobile_navlist satoshi_fontfamily">
                                                                        <li class="nav-item-mobile position-relative">
                                                                            <a href="{{ route('home') }}" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Home
                                                                                {{-- <span>
                                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                        <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                            ...
                                                                            {{-- <ul class="drop_down_menu drop_down_mobile_1">
                                                                                <li class="nav-item-mobile position-relative"><a href="{{ route('home') }}" class="nav-link-mobile position-relative custom_cursor_orangeglow">Home 1</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="index-2.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Home 2</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="index-3.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Home 3</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="index-4.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Home 4</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="index-5.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Home 5</a></li>
                                                                            </ul> --}}
                                                                        </li>
                                                                        <li class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Pages
                                                                                <span>
                                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                        <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                            ...
                                                                            <ul class="drop_down_menu drop_down_mobile_1">
                                                                                <li class="nav-item-mobile position-relative"><a href="about-us.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">About Us</a></li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Our Team
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="our-team-v1.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Team V1</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="our-team-v2.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Team V2</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative"><a href="BMI-calculator.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">BMI Calculator</a></li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Timetable
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="class-timetable.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Class Timetable</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="single-class-timetable.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Single Class Timetable</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative"><a href="our-program.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Our Program</a></li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Pricing
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="pricing-plans-v1.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Pricing V1</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="pricing-plans-v2.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Pricing V2</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative"><a href="faqs.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">FAQs</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="coming-soon.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Coming Soon</a></li>
                                                                                <li class="nav-item-mobile position-relative"><a href="error-404.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Error 404</a></li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Projects
                                                                                <span>
                                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                        <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                            ...
                                                                            <ul class="drop_down_menu drop_down_mobile_1">
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Grids
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-2-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid 2 Columns</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-3-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid 3 Columns</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-4-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid 4 Columns</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Grid Wide
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-wide-3-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">3 Columns Wide</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-wide-4-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">4 Columns Wide</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-grid-wide-5-column.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">5 Columns Wide</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Masonry
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-masonry-v1.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry V1</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-masonry-v2.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry V2</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-masonry-v3.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry V3</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-masonry-v4.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry V4</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Gallery
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="grid-gallery.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid Gallery</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="joined-gallery.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Joined Gallery</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single Images
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-single-images.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Images</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-small-images.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Small Images</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-big-images.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Big Images</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single Slider
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-single-slider.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Slider</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-small-slider.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Small Slider</a></li>
                                                                                        <li class="nav-item-mobile position-relative"><a href="project-big-slider.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Big Slider</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative"><a href="project-single-video.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Single Video</a></li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Blogs
                                                                                <span>
                                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                        <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                            ...
                                                                            <ul class="drop_down_menu drop_down_mobile_1">
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Blogs Standard
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard-right-sidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard Right Sidebar</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard-left-sidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard Left Sidebar</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Blogs Listing
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-listing-v1.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Listing V1</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-listing-v2.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Listing V2</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single Blog Right Sidebar
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Gallery</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Youtube Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Quote</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Link</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-rightsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single Blog Left Sidebar
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Gallery</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Youtube Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Quote</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Link</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-leftsidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);" class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single Blog No Sidebar
                                                                                        <span>
                                                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                                                                <path d="M0 0H24V24H0V0Z" fill="white"/>
                                                                                    ...
                                                                                    <ul class="inner_dropdown_menu">
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Standard</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Gallery</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Youtube Video</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Quote</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Link</a>
                                                                                        </li>
                                                                                        <li class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-nosidebar.html" class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                        <li class="nav-item-mobile position-relative"><a href="{{ route('contact') }}" class="nav-link-mobile position-relative custom_cursor_orangeglow">Contact US</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
